function [imgEvt evt header] = read_event_data(event_file)
...
%efile = 'E:/OSdataset/videos/A1/Event Export_Participant 1_participant 1-3-recording.txt';
...
stime = 0;
%%
if strcmp(header{4}, 'Version:	BeGaze 3.5.74') || strcmp(header{4}, 'Version:	BeGaze 3.5.90') ...
